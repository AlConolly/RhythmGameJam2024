...
public class NoteManager : MonoBehaviour
{
    ...
    private void Update()
    {
        time = RhythmEngine.GetCurrentAudioTime(); // Use the RhythmEngine to get the accurate current audio time
    ...
    {
        notePrefab = CheeseNotePrefab; // set to CheeseNotePreab cuz the compiler complains otherwise
    ...
    public Note? GetClosestNoteToInput(int key)
    {
        return GetClosestNoteToInput(key, time);
    }
}
